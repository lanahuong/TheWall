...
var Bonus = function(type, msg, brick, num, game) {
  ...
  if (type == "life") {
    ...
    switch(game.mf.x){
      case 1:
        this.img.src = "../../ressources/images/firefox_1x.png";
        break;
      case 1.5:
        this.img.src = "../../ressources/images/firefox_1,5x.png";
        break;
      case 2:
        this.img.src = "../../ressources/images/firefox_2x.png";
        break;
      case 2,25:
        this.img.src = "../../ressources/images/firefox_2,25x.png";
        break;
    }
  } else {
    this.x = game.w/2;
